@extends('layouts.app')
@section('title', 'Sign In — Basirah')
@section('description_content', 'Sign in to your Basirah account — access premium wholesale optical supplies, manage orders, and shop the best eyewear frames.')
...
@push('style')
    <style>
        ...
        *::after {
        ...
        .stagger-4 {
            animation: fadeSlideUp 0.5s 0.42s ease both;
        }

        .stagger-5 {
            animation: fadeSlideUp 0.5s 0.50s ease both;
        }

        .stagger-6 {
            animation: fadeSlideUp 0.5s 0.58s ease both;
        }

        .stagger-7 {
            animation: fadeSlideUp 0.5s 0.66s ease both;
        }
                    ...
                    <div class="col-lg-5 col-md-7 col-sm-10">
                        <div class="login-form-card" id="loginCard">
                            ...
                            <div class="login-header stagger-1">
                                <h1>Welcome Back <span class="glasses-emoji">👓</span></h1>
                                <p>Sign in to continue shopping the best frames</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login') }}" id="loginForm" novalidate>
                                ...
                                <div class="form-group-custom stagger-3">
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        <i class="bi bi-eye-slash input-icon-right" id="togglePassword"
                                ...
                                <!-- Remember Me -->
                                <div class="form-check-custom stagger-4">
                                    <input type="checkbox" id="remember" name="remember" {{ old('remember') ? 'checked' : '' }}>
                                    <label for="remember">Remember Me</label>
                                </div>

                                <!-- Submit Button -->
                                <button type="submit" class="btn-login stagger-5" id="btnLogin">
                            ...
                            <!-- Divider -->
                            <div class="login-divider stagger-6">
                                <span>OR</span>
                            </div>

                            <!-- Social Login -->
                            <button type="button" class="btn-social stagger-6" id="btnGoogleLogin">
                            ...
                            <!-- Register Prompt -->
                            <div class="register-prompt stagger-7">
